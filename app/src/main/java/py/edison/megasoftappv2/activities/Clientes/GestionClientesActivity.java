...
public class GestionClientesActivity extends AppCompatActivity implements ClientAdapter.OnClientListener {
    ...
    private void configurarRecyclerView() {
        ...
        // Configurar scroll infinito (paginación)
        recyclerViewClientes.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                if (!recyclerView.canScrollVertically(1)) {
                    // Lógica para cargar más clientes si es necesario
                }
            }
        });
    }
    ...
    private void mostrarDialogoCliente(Client clienteExistente) {
        ...
        View dialogView = LayoutInflater.from(this).inflate(R.layout.dialogo_cliente, null);
