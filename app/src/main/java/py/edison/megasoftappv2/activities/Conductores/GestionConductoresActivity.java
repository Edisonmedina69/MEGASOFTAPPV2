...
public class GestionConductoresActivity extends AppCompatActivity implements ConductorAdapter.OnConductorListener {
    ...
    private void cargarConductores() {
        showProgress();
        conductorService.obtenerConductores(new ConductorListCallback() {
            @Override
    ...
    private void mostrarDialogoConductor(Conductor conductorExistente) {
        ...
        View dialogView = LayoutInflater.from(this).inflate(R.layout.dialogo_conductor, null);
        ...
        if (conductorExistente != null) {
            ...
            etIdentidad.setText(conductorExistente.getIdentidadDriver());
        }
        ...
        builder.setView(dialogView)
                .setPositiveButton("Guardar", (dialog, which) -> {
                    ...
                    conductor.setIdentidadDriver(etIdentidad.getText().toString());
    ...
    private boolean validarConductor(Conductor conductor) {
        ...
        if (conductor.getIdentidadDriver().trim().isEmpty()) {
            mostrarError("Identidad es requerida");
            return false;
        }
        return true;
    }
    ...
    private void guardarConductor(Conductor conductor) {
        showProgress();
        conductorService.guardarConductor(conductor, new ConductorListCallback() {
            @Override
            public void onSuccess(List<Conductor> conductores) {
                hideProgress();
                mostrarMensaje("Conductor guardado");
                cargarConductores();
            }
    ...
    private void actualizarConductor(Conductor conductor) {
        ...
        conductorService.guardarConductor(conductor, new ConductorListCallback() {
            ...
            public void onSuccess(List<Conductor> conductores) {
                hideProgress();
                mostrarMensaje("Conductor actualizado");
                cargarConductores();
            }
    ...
    private void eliminarConductor(String conductorId) {
        showProgress();
        conductorService.eliminarConductor(conductorId, new ConductorListCallback() {
            @Override
            public void onSuccess(List<Conductor> conductores) {
                hideProgress();
                mostrarMensaje("Conductor eliminado");
                cargarConductores();
            }
